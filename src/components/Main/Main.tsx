      ...
      <div className={styles.main__wrapper}>
        {!isOpenMessageTemplateEditor ? (
          <p className={styles.main__text}>
            ...
            dolores, odit nisi assumenda ut asperiores architecto magnam totam. Quo assumenda vitae
            aut quia accusamus non explicabo dolore officia ipsum vero. Illo unde quaerat
            exercitationem cum porro ut aspernatur, blanditiis earum nisi perspiciatis. Incidunt
            molestias numquam autem rerum soluta? Aliquam molestias voluptates commodi voluptatibus
            obcaecati placeat culpa, mollitia cumque quae tenetur fugit illum alias sequi
            exercitationem recusandae, aliquid omnis esse? Dolore nesciunt cumque minima delectus
            suscipit saepe iusto totam! Hic quis tempore perspiciatis, maxime quibusdam veritatis
            ipsum, praesentium voluptatibus obcaecati minima minus in accusantium. Harum cum
            accusamus, autem repellendus inventore, provident eum fuga quaerat a perferendis quidem
            quisquam est? Consectetur natus eius obcaecati temporibus eaque aut dicta iste fugiat ut
            amet labore, quis laudantium et excepturi! Voluptatem itaque, necessitatibus
            ...
            repudiandae, beatae ipsum mollitia earum illum possimus accusamus? Sit cum fugiat, quia,
            <h3 style={{ textAlign: 'center' }}>
